        ...
        <div className="max-w-5xl">
          ...
          {socialSection.links.map((link) => (
            <a
              ...
              className="flex items-center gap-3 bg-card border border-border rounded-lg px-4 py-3.5 transition-all duration-200 hover:-translate-y-0.5 hover:border-muted-foreground/30 group"
              style={{
            ...
            >
              <span className="w-9 h-9 rounded-full flex items-center justify-center border border-border bg-secondary/80 flex-shrink-0">
                <svg
                  viewBox="0 0 24 24"
                  className="w-4 h-4 fill-current text-muted-foreground group-hover:text-foreground transition-colors duration-200"
                >
