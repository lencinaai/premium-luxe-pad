...
export default function HeroSection() {
  const { activeIndex, images } = useHeroRotation(
    heroContent.images,
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center scroll-mt-header overflow-hidden">
      ...
      {/* Rotating background layer - Mapping all for stability */}
      ...
      {/* Extra darkening on text side - Softened */}
      <div
        className="absolute inset-0 z-[1] pointer-events-none"
        style={{
          background:
            "linear-gradient(105deg, hsl(var(--background) / 0.6) 30%, transparent 70%)",
        }}
      />
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-6 py-24 lg:py-0">
        ...
        <div className="lg:hidden flex flex-col items-center text-center">
          ...
          <h1 className="leading-[1.1] mb-10">
            <span className="block font-sora text-[2.6rem] sm:text-5xl font-extrabold text-white uppercase tracking-[0.04em]">
              Cristian
            </span>
          ...
          {/* Portrait */}
          <div className="w-40 h-52 sm:w-48 sm:h-60 rounded-lg border border-border overflow-hidden shadow-lg bg-card mb-10">
            <img
              src={profilePhoto}
          ...
          <div className="space-y-4 mb-10 w-full">
            <div className="bg-card/60 backdrop-blur-sm border border-border rounded-lg p-6 card-glow">
