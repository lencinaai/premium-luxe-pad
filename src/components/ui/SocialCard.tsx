...
export default function SocialCard({ label, url, icon }: Props) {
  return (
    <a
      href={url}
      target="_blank"
      ...
      aria-label={label}
      className="flex items-center gap-3 bg-card border border-border rounded-lg px-5 py-4 card-glow"
    >
      <svg viewBox="0 0 24 24" className="w-5 h-5 text-primary fill-current flex-shrink-0">
